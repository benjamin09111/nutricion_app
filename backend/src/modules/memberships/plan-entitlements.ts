...
export const MEMBERSHIP_PLAN_ENTITLEMENTS: Record<string, PlanEntitlements> = {
  free: {
    [PLAN_ENTITLEMENT_KEYS.PATIENTS_ACTIVE_LIMIT]: 15,
    [PLAN_ENTITLEMENT_KEYS.CONSULTATIONS_MONTHLY_LIMIT]: 15,
    [PLAN_ENTITLEMENT_KEYS.PDF_MONTHLY_LIMIT]: 9,
    ...
    [PLAN_ENTITLEMENT_KEYS.CLINICAL_CALCULATOR_LIMIT]: 30,
    [PLAN_ENTITLEMENT_KEYS.FOOD_GROUPS_ACCESS]: false,
    [PLAN_ENTITLEMENT_KEYS.AI_CALLS_LIMIT]: 9,
