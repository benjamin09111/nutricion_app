...
exports.RECIPES_AI_PROMPTS = {
    base: [
        ...
        'Cada receta debe incluir: slotId, mealSection, title, description, preparation, recommendedPortion, portions, complexity, protein, calories, carbs, fats, ingredients, mainIngredients, extraIngredients.',
        'ingredients debe ser un arreglo de objetos con la forma {"name":"string","quantity":"string","amount":0,"unit":"g"} cuando sea posible.',
        'Si conoces la cantidad total del ingrediente para la receta completa, usa amount y unit. Si no, al menos entrega name y quantity.',
