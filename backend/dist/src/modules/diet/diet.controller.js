...
const verify_foods_dto_1 = require("./dto/verify-foods.dto");
let DietController = class DietController {
    dietService;
    constructor(dietService) {
        this.dietService = dietService;
    }
    async verifyFoods(body) {
        return this.dietService.verifyFoodsAgainstRestrictions(body);
    }
};
exports.DietController = DietController;
__decorate([
    (0, common_1.Post)('verify-foods'),
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [verify_foods_dto_1.VerifyFoodsDto]),
    __metadata("design:returntype", Promise)
], DietController.prototype, "verifyFoods", null);
