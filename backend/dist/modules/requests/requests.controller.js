...
let RequestsController = class RequestsController {
    ...
    updateStatus(id, body, req) {
        if (!['ADMIN', 'ADMIN_MASTER', 'ADMIN_GENERAL'].includes(req.user.role)) {
            throw new common_1.UnauthorizedException('Solo el administrador puede gestionar peticiones');
        }
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_registration_request_dto_1.CreateRegistrationRequestDto]),
