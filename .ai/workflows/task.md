...
- **Consult the Glossary**: Read `.ai/context/glossary.md` to identify if you are working on a **Sequential Flow** (Entregable Personalizado) or a **Standalone Module**.

## 2. Technical Mapping
- **Locate Files**: Use `.ai/map/files.md` to identify the relevant frontend components and backend services.
...
- **Pattern Check**: Did a new technical pattern emerge? -> Create proposal in `/.ai/evolution/proposals.md`.
- **Feedback**: Did you repeat a mistake? -> Log it in `/.ai/feedback.md`.
