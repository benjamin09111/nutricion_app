...
- **Follow Coding Rules**: Ensure the fix follows the standards in `.agents/rules/coding.md`.

## 4. Side Effect Verification
- **Audit Dependencies**: Consult `.agents/rules/safety.md` and map out dependencies to ensure the fix doesn't break other parts of the clinical flow.
