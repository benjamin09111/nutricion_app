...
export function WelcomeOverlay() {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 bg-slate-950/80 animate-in fade-in duration-300">
      <div className="relative w-full max-w-2xl max-h-[calc(100dvh-2rem)] overflow-y-auto rounded-3xl bg-slate-900 border border-slate-800 p-6 sm:p-10 shadow-2xl shadow-slate-950/80 animate-in zoom-in-95 slide-in-from-bottom-8 duration-500 [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden">
        <button
        ...
        <div className="flex flex-col">
          ...
          <Button
            onClick={handleDismiss}
            className="mt-8 h-12 w-full rounded-2xl bg-white text-sm font-black uppercase tracking-widest text-indigo-700 shadow-lg hover:bg-slate-100 cursor-pointer"
          >
            Explorar NutriNet
          </Button>
        </div>
