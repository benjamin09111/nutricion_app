        ...
        return (
            <button
                className={cn(
                    ...
                    {
                        "bg-emerald-600 text-white hover:bg-emerald-500 shadow-sm": variant === "default",
                        "bg-slate-100 text-slate-900 hover:bg-slate-200/80": variant === "secondary",
                        "border border-slate-200 bg-white text-slate-900 hover:bg-slate-100 hover:text-slate-900": variant === "outline",
