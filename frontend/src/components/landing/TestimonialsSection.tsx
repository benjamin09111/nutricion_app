...
import { Star, Quote, CheckCircle2, Award, Sparkles, Building2, UserCheck } from "lucide-react";
          ...
          {TESTIMONIALS.map((t, idx) => (
            ...
            >
              ...
              <div className="mt-8 pt-4 border-t border-slate-800/80 flex items-center gap-3">
                <div className={`h-11 w-11 rounded-2xl bg-gradient-to-br ${t.avatarBg} text-white font-bold text-sm flex items-center justify-center shadow-md shrink-0`}>
                  {t.avatarText}
                </div>
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-[10px] text-emerald-400 font-semibold truncate flex items-center gap-1 mt-0.5">
                    <UserCheck className="h-3 w-3" /> {t.city}, Chile
                  </p>
                </div>
              </div>
            </div>
