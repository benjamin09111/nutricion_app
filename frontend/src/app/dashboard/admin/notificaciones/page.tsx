...
export default function AdminNotificationsPage() {
    ...
    return (
        <div className="max-w-3xl mx-auto py-8 px-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 md:p-8">
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-700">Enlace (Opcional)</label>
                            <Input
                                placeholder="https://..."
                                value={link}
            ...
            {/* Preview Section */}
            <div className="mt-8">
                <h3 className="text-sm font-bold text-slate-400 uppercase tracking-wider mb-4">Vista Previa</h3>
                <div className="bg-slate-50 border border-dashed border-slate-200 rounded-xl p-6 opacity-75">
                    <div className="flex gap-4 items-start">
                        <div className={`p-3 rounded-xl h-fit w-fit
                        ...
                        <div>
                            <h4 className="font-bold text-slate-900">{title || 'Título de la notificación'}</h4>
