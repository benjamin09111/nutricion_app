...
import SmartPatientHeader, {
  PatientData,
} from "@/components/layout/SmartPatientHeader";
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 border-b border-slate-200 pb-8">
          <div className="space-y-2">
            <div className="flex items-center gap-2 text-rose-600 font-black text-[10px] uppercase tracking-widest">
              <span className="bg-rose-100 px-2 py-0.5 rounded">
                Fase Adicional
              </span>
            ...
            <p className="text-slate-500 font-medium">
              Sincroniza la nutrición con la actividad física para maximizar
              resultados.
            </p>
          </div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 font-medium">
                          La IA ajusta la intensidad al objetivo.
                        </p>
                      </div>
                    </div>
                    <div
                  ...
                  <div className="flex items-start justify-between mb-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-slate-500 font-medium">
                          Selecciona la intensidad deseada.
                        </p>
                      </div>
                    </div>
                    <div
                  ...
                  {fitnessState.cardio.enabled && (
                    ...
                    >
                      <div className="grid grid-cols-3 gap-2">
                        {(["suave", "moderado", "intenso"] as const).map(
                          (l) => (
                            <button
                              key={l}
                              onClick={() =>
                                updateCategory("cardio", "level", l)
                              }
                              className={cn(
                    ...
                    >
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateCategory("sports", "type", e.target.value)
                          }
                          className="bg-slate-800 border-slate-700 text-white font-bold h-10 rounded-xl"
                        />
                      </div>
                    ...
                    >
                      <div>
                        ...
                        <Input
                          ...
                          onChange={(e) =>
                            updateCategory("lowImpact", "type", e.target.value)
                          }
                          className="bg-slate-800 border-slate-700 text-white font-bold h-10 rounded-xl"
                        />
                      </div>
          ...
          <div className="lg:col-span-4 space-y-6">
            <div className="bg-emerald-50 border border-emerald-100 p-8 rounded-[3rem] space-y-6">
              ...
              <p className="text-sm text-slate-600 font-medium">
                Estas metas son importadas del perfil del paciente y guían el
                entrenamiento.
              </p>
              ...
              <div className="space-y-3">
                {(patient?.fitnessGoals
                  ...
                  <div
                    key={i}
                    className="flex items-center gap-3 bg-white p-4 rounded-2xl border border-emerald-100 shadow-sm cursor-default"
                  >
              ...
              <div className="pt-4 border-t border-emerald-100">
                ...
                <p className="text-2xl font-black text-slate-800">
                  ~1,850{" "}
                  <span className="text-sm text-slate-400">kcal/sem</span>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs font-bold text-slate-600">
                Puedes saltar esta fase o añadir notas para el entregable.
              </p>
            </div>
          </div>
