    ...
    <div className="space-y-8 max-w-6xl mx-auto pb-10">
      ...
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between border-b border-slate-200 pb-6">
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-lg max-w-2xl pl-12">
            El futuro de la nutrición clínica. Un equipo de expertos digitales
            trabajando 24/7 para ti y tus pacientes.
          </p>
        </div>
        <Badge
          variant="outline"
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        <Card className="relative overflow-hidden border-slate-200 hover:border-emerald-200 transition-all duration-300 shadow-sm hover:shadow-md group">
          ...
          <CardHeader>
            <Badge className="w-fit mb-2 bg-blue-100 text-blue-700 hover:bg-blue-200 border-none">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-slate-600 leading-relaxed">
              ¿Necesitas reemplazar un alimento caro por uno económico pero con
              la misma proteína? Solo pregúntale. El Copiloto conoce tu base de
              datos de alimentos y precios al revés y al derecho.
            </p>
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 italic text-sm text-slate-500">
              "Dame 3 alternativas al salmón, menores a $5.000 CLP, altas en
              Omega-3 disponibles en Jumbo."
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-slate-200 hover:border-emerald-200 transition-all duration-300 shadow-sm hover:shadow-md group">
          ...
          <CardHeader>
            <Badge className="w-fit mb-2 bg-purple-100 text-purple-700 hover:bg-purple-200 border-none">
              Para el Paciente
            </Badge>
            <CardTitle className="flex items-center gap-2 text-xl">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-slate-600 leading-relaxed">
              Tus pacientes nunca más se sentirán solos. Este agente responde
              dudas cotidianas basándose EXCLUSIVAMENTE en el plan que tú
              diseñaste.
            </p>
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 italic text-sm text-slate-500">
              "Estoy en un cumpleaños, ¿qué puedo comer del picoteo sin salirme
              de mis macros?"
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="relative overflow-hidden border-slate-200 hover:border-emerald-200 transition-all duration-300 shadow-sm hover:shadow-md group">
          ...
          <CardHeader>
            <Badge className="w-fit mb-2 bg-amber-100 text-amber-700 hover:bg-amber-200 border-none">
          ...
          <CardContent className="space-y-4">
            <p className="text-sm text-slate-600 leading-relaxed">
              Un agente silencioso que revisa semanalmente los precios de
              supermercados. Te avisa proactivamente si los costos de tus dietas
              suben demasiado para proteger el bolsillo de tus pacientes.
            </p>
            <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 italic text-sm text-slate-500">
              "Alerta: El precio del pollo subió un 15% esta semana. Sugiero
              cambiar a pavo."
            </div>
          </CardContent>
        </Card>
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start md:items-center justify-between">
            <div className="space-y-4 max-w-2xl">
              ...
              <p className="text-slate-300 text-lg leading-relaxed">
                La IA no viene a reemplazarte, viene a potenciarte. Con estos
                agentes, podrás pasar de atender 50 pacientes a 200, manteniendo
                la misma calidad humana y cercanía, pero eliminando el trabajo
                repetitivo.
              </p>
