...
export default function RecipesClient() {
  ...
  const [complexityPreference, setComplexityPreference] = useState<
    "simple" | "elaborada"
  >("simple");
  ...
  const printJson = () => {
    ...
    console.log("Metas Nutricionales:", {
      targetProtein,
      targetCalories,
      targetCarbs,
      targetFats,
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs font-bold text-slate-600">
                  Balance del lunes óptimo y coherente con el carrito.
                </p>
              </div>
            </div>
                    ...
                    <div className="flex flex-col items-center gap-2 pt-2">
                      <div className="relative group/time">
                        ...
                        <input
                          ...
                          value={slot.time}
                          onChange={(e) =>
                            handleTimeChange(slot.id, e.target.value)
                          }
          ...
          >
            ...
            >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-medium text-slate-500 tracking-widest uppercase">
                      Explora opciones equivalentes para este slot.
                    </p>
                  </div>
                </div>
                <button
                  ...
                  {MOCK_RECIPES.map((r) => (
                    <div
                      ...
                      onClick={() => {
                        setCurrentSlots((prev) =>
                          prev.map((s) =>
                            s.id === activeSwapSlot ? { ...s, recipe: r } : s,
                          ),
                        );
              ...
              <div className="p-6 bg-slate-50 border-t border-slate-100 flex justify-end gap-3">
                ...
                <Button className="bg-slate-900 text-white font-black rounded-2xl px-10 h-12 shadow-xl shadow-slate-200">
                  Guardar Cambios
                </Button>
              </div>
            </div>
