...
export default function ManageTagsModal({ isOpen, onClose, ingredient, availableTags = [], onSuccess }: ManageTagsModalProps) {
    ...
    useEffect(() => {
        if (ingredient) {
            ...
            const personalTags = ingredient.preferences?.[0]?.tags?.map(t => t.name) || [];
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const response = await fetch(`${apiUrl}/foods/${ingredient.id}/preferences`, {
                method: 'PATCH',
                headers: {
                                ...
                                <div className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-400 mt-2">
                                            Estos tags te ayudarán a filtrar y encontrar este ingrediente más tarde.
                                        </p>
                                    </div>
