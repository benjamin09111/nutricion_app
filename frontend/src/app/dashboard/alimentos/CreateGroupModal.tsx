    ...
    return (
        ...
        >
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
                <div>
                    <label className="text-sm font-medium text-slate-700 mb-1 block">Nombre del Grupo *</label>
                    <Input
                ...
                <div>
                    <label className="text-sm font-medium text-slate-700 mb-1 block">Descripción (Opcional)</label>
                    <textarea
                ...
                <div>
                    <label className="text-sm font-medium text-slate-700 mb-1 block">Tags (Opcional)</label>
                    <TagInput
                        value={tags}
                        onChange={setTags}
                        placeholder="Escribe y presiona Enter..."
                    />
                    <p className="text-xs text-slate-400 mt-1">Ayudan a filtrar y organizar tus grupos.</p>
                </div>
