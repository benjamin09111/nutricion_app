## No para MVP, sino módulo aparte

Tener una plataforma PARA el usuario, puede llenar y seleccionar los alimentos que ha comido y ver sus valores nutricionales. Idea de tener "recompensas" (puntos o estrellas) como puntos al seguir la pauta del nutri o comer/cumplir tareas (efecto psicológico de la recompensa). Integrarlo con el seguimiento con su nutri, pero tener una plataforma de usuarios.

Dar a los nutris una opción de tener un chatbot para responder preguntas simples. La IA puede responder preguntas básicas, como "¿cuánta proteína tiene este alimento?" o "¿cuál es un buen sustituto de la carne?", todo basado en conocimiento nutricionista.
